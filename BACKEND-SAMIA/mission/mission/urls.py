...
urlpatterns = [
    ...
    path('Processus_step/<int:id_process>/', views.Processus_step.as_view()),
    ...
    path('Config_rapportList/', views.Config_rapportList.as_view()),
    path('Config_rapportdetail/<int:pk>/', views.Config_rapportDetail.as_view()),
    path('RapportList/', views.RapportList.as_view()),
    path('Rapportdetail/<int:pk>/', views.RapportDetail.as_view()),
    path('rapport_envoyeDetail/<int:id_envoye>/', views.rapport_envoyeDetail.as_view()),
    ...
    path('Contrainte/<int:id_process>/', views.Contrainte.as_view()),
    ...
    path('Config_blocageList/', views.Config_blocageList.as_view()),
    path('Config_blocageDetail/', views. Config_blocageDetail.as_view()),
